...
<div class="pd-hero pd-hero--tall pd-hero--zoom pd-hero--sketch">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Architecture, Residential · Surat</span>
    <h1>Vritta</h1>
...
<section class="pd-showcase elev-sec">
  <div class="container">
    ...
    <div class="pd-full-grid pd-full-grid--elev reveal">
      <figure class="pd-full"><img decoding="async" src="${IMG}elev-1-day.webp" data-day="${IMG}elev-1-day.webp" data-night="${IMG}elev-1-night.webp" alt="Vritta, street-corner elevation" loading="lazy" /></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG}elev-2-day.webp" data-day="${IMG}elev-2-day.webp" data-night="${IMG}elev-2-night.webp" alt="Vritta, garden-corner elevation" loading="lazy" /></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG}elev-3-day.webp" data-day="${IMG}elev-3-day.webp" data-night="${IMG}elev-3-night.webp" alt="Vritta, side elevation with brick jaali" loading="lazy" /></figure>
    </div>
    <div class="elev-lights__bar reveal">
      <button class="nightbtn" type="button" aria-pressed="false">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M9 18h6M10 21h4M12 3a6 6 0 0 0-3.5 10.9c.5.4.8 1 .8 1.6v.5h5.4v-.5c0-.6.3-1.2.8-1.6A6 6 0 0 0 12 3z"/></svg>
...
<section class="section pd-sketch">
  <div class="container">
    ...
    <div class="grid-2 top site-analysis" style="align-items:center">
      <figure class="reveal" style="margin:0">
        <img decoding="async" src="${IMG5}site-analysis.svg" alt="Vallabh Nivas site analysis, the sun's path and the prevailing wind across the plot" loading="lazy" />
      </figure>
      <div class="reveal d1">
        <p class="lead">A corner plot between the main road and the society road set the brief, the massing turned to hold privacy to the street while opening the living floors to light and air.</p>
        <p class="muted">The southern sun washes the deep balconies through the day, and the prevailing breezes are drawn across the plan for cross and stack ventilation, floor to floor.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section section--paper2">
  <div class="container">
    ...
    <div class="pd-full-grid pd-full-grid--plans pd-full-grid--zoom pd-full-grid--zoomcap reveal">
      <figure class="pd-full"><img decoding="async" src="${IMG5}plans/ground.webp" alt="Vallabh Nivas ground floor plan" loading="lazy" /><figcaption class="pd-full__cap">Ground floor</figcaption></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG5}plans/first.webp" alt="Vallabh Nivas first floor plan" loading="lazy" /><figcaption class="pd-full__cap">First floor</figcaption></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG5}plans/second.webp" alt="Vallabh Nivas second floor plan" loading="lazy" /><figcaption class="pd-full__cap">Second floor</figcaption></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG5}plans/third.webp" alt="Vallabh Nivas third floor plan" loading="lazy" /><figcaption class="pd-full__cap">Third floor</figcaption></figure>
      <figure class="pd-full"><img decoding="async" src="${IMG5}plans/terrace.webp" alt="Vallabh Nivas terrace floor plan" loading="lazy" /><figcaption class="pd-full__cap">Terrace floor</figcaption></figure>
    </div>
  </div>
</section>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Interior Design, Residential · Surat</span>
    <h1>Metal Life</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Interior Design, Café · Surat</span>
    <h1>Juneberry</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Interior Design, Showroom · Surat</span>
    <h1>Calibre</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Interior Design, Office · Surat</span>
    <h1>ICON Rosca</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">Interior Design, Residence · Surat</span>
    ...
    <div class="ldr reveal">
      ...
      <div class="ldr__bios">
        <div class="ldr__bio">
          ...
          <p class="muted">Bhavin Swami leads Tvastra Design LLP as its Founder and principal designer. With over three decades of practice, he sets the studio's design direction across architecture, interiors and product, pairing a deep respect for tradition and craft with a modern, problem-solving mindset.</p>
  ...
  <div class="container">
    <div class="grid-2 top">
      ...
      <ul class="certs reveal d1">
        ...
        <li class="cert"><span class="cert__yr">2020</span><div class="cert__body"><div class="cert__title">Photography Masterclass</div><div class="cert__by">Udemy &middot; A Complete Guide to Photography &middot; 22.5 hours</div></div><a class="cert__thumb" href="assets/founder/certs/udemy-photography.webp" target="_blank" rel="noopener"><img decoding="async" src="assets/founder/certs/udemy-photography.webp" alt="Udemy Photography Masterclass certificate of completion" loading="lazy" /></a></li>
        <li class="cert"><span class="cert__yr">2003</span><div class="cert__body"><div class="cert__title">Associate Member, IIID</div><div class="cert__by">Indian Institute of Interior Designers &middot; Reg. AM-1743</div></div><a class="cert__thumb" href="assets/founder/certs/iiid-member.webp" target="_blank" rel="noopener"><img decoding="async" src="assets/founder/certs/iiid-member.webp" alt="Indian Institute of Interior Designers Associate Member certificate" loading="lazy" /></a></li>
      </ul>
    </div>
  </div>
</section>
...
<div class="${heroCls}">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#fff">${o.tag}</span>
    <h1>${o.name}</h1>
