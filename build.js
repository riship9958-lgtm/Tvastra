...
<div class="pd-hero pd-hero--tall pd-hero--zoom pd-hero--sketch">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Architecture, Residential · Surat</span>
    <h1>Vritta</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Interior Design, Residential · Surat</span>
    <h1>Metal Life</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Interior Design, Café · Surat</span>
    <h1>Juneberry</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Interior Design, Showroom · Surat</span>
    <h1>Calibre</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Interior Design, Office · Surat</span>
    <h1>ICON Rosca</h1>
...
<div class="pd-hero pd-hero--tall">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">Interior Design, Residence · Surat</span>
...
<div class="${heroCls}">
  ...
  <div class="pd-hero__cap"><div class="container">
    <span class="tag" style="color:#4169e1">${o.tag}</span>
    <h1>${o.name}</h1>
